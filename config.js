...
var DRAW_TOOLS_CONFIG = [
	...
	{name: 'draw_square', 	title: 'Draw rectangle',	icon: ['sprites.png', -400+3, 5],	attributes: {size: 1, fill: false, square: false}	},
	{name: 'draw_circle', 	title: 'Draw circle',		icon: ['sprites.png', -450+3, 5],	attributes: {size: 1, fill: false, circle: false}	},
